...
public class VendingMachineTest {
	...
	public void testAddItemSlotB() {
		try {
			...
			assertEquals("Result",item,vending.getItem("B"));
		}
		catch (Exception e) { 
			fail("Should not have thrown exception!");
		}
	...
	public void testAddItemSlotC() {
		try {
			vending.addItem(item, "C");
			assertEquals("Result",item,vending.getItem("C"));
		}
		catch (Exception e) { 
			fail("Should not have thrown exception!");
		}
	...
	public void testAddItemSlotD() {
		try {
			vending.addItem(item, "D");
			assertEquals("Result",item,vending.getItem("D"));
		}
		catch (Exception e) { 
			fail("Should not have thrown exception!");
		}
